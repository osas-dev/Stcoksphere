<x-app-layout>
    ...
    <div class="flex justify-end mb-4">
        <a href="{{ route('user.transactions.withdrawals.methods') }}"
    ...
    <div class="w-full mb-8 overflow-hidden rounded-lg shadow-xs">
                    ...
                    @if ($withdrawals->isEmpty())
                        <tr class="text-gray-700 dark:text-gray-400">
                            <td class="px-4 py-3 text-sm text-center" colspan="5">
                                <p class="font-semibold">You have ot made any withdrawals...</p>
                            </td>
                        </tr>
                    @else
                        @foreach ($withdrawals as $withdrawal)
                            <tr class="text-gray-700 dark:text-gray-400">
                                <td class="px-4 py-3 text-sm">
                                    <p class="font-semibold">{{ $withdrawal->txid }}</p>
                                </td>
                                <td class="px-4 py-3 text-sm">
                                ...
                                <td class="px-4 py-3 text-xs">
                                    ...
                                    @elseif ($withdrawal->status === 'pending')
                                        <span class="px-2 py-1 font-semibold leading-tight rounded"
        ...
        <div
            ...
            <span class="flex items-center col-span-3">
                Showing {{ $withdrawals->firstItem() }}-{{ $withdrawals->lastItem() }} of {{ $withdrawals->total() }}
            </span>
